...
module.exports = {
    ...
    start: {
      ...
      edit: {
        perms: `${e.error} У Вас немає права \`MANAGE_MESSAGES\`, Ви можете зробити роль для використання цієї ролі:`,
        msg: `${e.error} Вкажіть коректний ID!`,
        argswinners: `${e.error} укажіть \`кол-во переможців!\`\n> Приклад: \`%gstart #giveawaychannel 1h 2(2: кол-во переможців) Nitro\``,
        prize:  `${e.error} додайте \`приз\`, будь ласка!\n> Приклад: %gstart #giveawaychannel 1h 2 \`Nitro(Nitro: приз)\``,
        err: `${e.error} Невідомий ID для розіграша:`,
      ...
      invite: {
        ...
        disc: `Введіть \`${config.prefix}invite copy\`, щоб отримати посилання!`,
    ...
    cmd: `**${config.prefix}start ${e.right} Розпочати розіграш.**\n**${config.prefix}end ${e.right} Закінчити розіграш.**\n**${config.prefix}edit ${e.right} Змінити параметри розіграша.**\n**${config.prefix}reroll ${e.right} Выбрати нового переможця.**\n **${e.featured}__Корисні команди:__**\n**${config.prefix}setlang ${e.right} Змінити мову.**\n**${config.prefix}set logs ${e.right} Встановити канал для логів.**\n**${config.prefix}set mention on ${e.right} Активувать повідомлення для розіграшів.**\n**${config.prefix}set mention off ${e.right} Відключіть повідомлення для розіграшів.**`,
    cmm: `__${e.command} Информація по командам__`,
    cmdd: `**${config.prefix}help ${e.right} Показати всі команди бота.**\n**${config.prefix}ping ${e.right} Пінг бота.**\n**${config.prefix}invite ${e.right} Запрошенні посилання.**`,
