...
module.exports = {
  ...
  lastchance: {
    content: `${e.warning} **اخر حظ للدخول للقيف اوي !** ${e.warning}`,
  },
  ...
  edit: {
    ...
    timepr: (numberOfSecondsMax) =>
      `${e.success} سوف يتم تغيير الجائزة حالا بعد \`${numberOfSecondsMax}\` ثواني.`,
    timwi: (numberOfSecondsMax) =>
      `${e.success} سوف يتم تغيير عدد الفائزون حالا بعد \`${numberOfSecondsMax}\` ثواني.`,
    err: `${e.error} تعذر التعرف على القيف اوي هذه:`,
    errmod: `${e.error} هذه القيف اوي لقد انتهت او تم حذفها سابقا!.`,
  },
  ...
  myprefix: {
    hello: `${e.info} |  مرحبا `,
    prefixis: (guildData) =>
      ` البادئة في هذا السيرفر هي \`${guildData.prefix}\`.استخدم \`${guildData.prefix}help\` للحصول على قائمة الاوامر!`,
  },
  blacklist: {
    blacklist:
      ":lock: | **لا يمكنك استخدام`ManageGift Commands` لانك ممنوع بسبب مخالفتك قوانين البوت",
  },
};
