...
module.exports = {
    ...
    start: {
      ...
      lang: {
        perms: `${e.error} У Вас нет права \`MANAGE_MESSAGES\`, Вы можете создать роль для использования данной команды:`,
        msg: `${e.error} пожалуйста, укажите язык (\`ar\`, \`en\`, \`ru\`)`,
    ...
    disc: 'Это open-source проект для создания розыграшей с возможностью полной настройки. Бот написан на языке `javascript language` и сделал: ! -  HaDi KouBeIssI | 🇱🇧#4001! Перевод: LWJerri#3290',
