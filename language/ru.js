...
module.exports = {
  ...
  stats: {
    title: `ManageGift's информация:`,
    info: 'Это open-source проект для создания розыграшей с возможностью полной настройки. Бот написан на языке `javascript` и его сделал: ! -  HaDi KouBeIssI | 🇱🇧#4001! Перевод: LWJerri#3290',
